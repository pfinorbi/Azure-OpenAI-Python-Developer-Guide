...
var cAppEnvAppLogsConfiguration = deployLogging ? {
...
var appServiceWebSettingsProperties = deployLogging ? {
...
resource openAiEmbeddingsModelDeployment 'Microsoft.CognitiveServices/accounts/deployments@2023-05-01' = if(deployOpenAI) {
...
resource openAiCompletionsModelDeployment 'Microsoft.CognitiveServices/accounts/deployments@2023-05-01' = if(deployOpenAI) {
  parent: openAiAccount
...
resource logAnalytics 'Microsoft.OperationalInsights/workspaces@2021-06-01' = if (deployLogging) {
...
resource appServiceWebInsights 'Microsoft.Insights/components@2020-02-02' = if (deployLogging) {
...
resource appServiceWebSettings 'Microsoft.Web/sites/config@2022-03-01' = {
  ...
  name: 'appsettings'
  kind: 'string'
  properties: appServiceWebSettingsProperties
}
...
resource containerAppEnvironment 'Microsoft.App/managedEnvironments@2023-05-01' = {
  ...
  location: location
  properties: {
    appLogsConfiguration: cAppEnvAppLogsConfiguration
    /*
    workloadProfiles: [
      {
        name: 'Warm'
